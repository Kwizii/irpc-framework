...
public class ConsistentHashLoadBalancer extends AbsLoadBalancer {
    ...
    @Override
    protected String doSelect(List<String> serviceAddresses, IRpcRequest rpcRequest) {
        ...
        return selector.select(rpcServiceName + Arrays.stream(rpcRequest.getParamValues()));
    }
